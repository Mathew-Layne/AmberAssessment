<div>
                            ...
                            <div class="w-full lg:w-12/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model="schedule" placeholder="Enter Day And Time">
    ...
    <x-table.table>
        <x-table.thead>
            ...
            <x-table.table-head>Date and Time</x-table.table-head>
        ...
        <x-table.tbody>
            ...
            <x-table.table-row>
                <x-table.table-data responsiveName="Last Name">{{ $schedule->date_time }}</x-table.table-data>
    ...
    <div class="mt-3">
        <x-table.button wire:click="$set('addform', true)" color='gray' class="py-3 px-6">Add Course</x-table.button>
    </div>
