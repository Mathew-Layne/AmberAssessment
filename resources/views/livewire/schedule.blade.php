<div>
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full lg:w-12/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    @error('schedule')<span class="text-xs text-red-600">{{
                            ...
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input type="time"
                                        class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                        wire:model="start_time" placeholder="Enter Teachers Name">
                            ...
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input type="time"
                                        class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                        wire:model="end_time" placeholder="Enter Teachers Name">
                            ...
                            <div class="ml-3 mt-3">
                                <x-table.button color="gray" class="py-2 px-4">Add Schedule </x-table.button>
                            </div>
    ...
    <x-table.table>
        <x-table.thead>
            ...
            <x-table.table-head>Day</x-table.table-head>
        ...
        <x-table.tbody>
            ...
            <x-table.table-row>
                <x-table.table-data responsiveName="Last Name">{{ $schedule->day }}</x-table.table-data>
                <x-table.table-data responsiveName="Last Name">{{ $schedule->start_time }}</x-table.table-data>
                <x-table.table-data responsiveName="Last Name">{{ $schedule->end_time }}</x-table.table-data>

                <x-table.table-data responsiveName="Class">
                    <x-table.button wire:click="editSchedule({{ $schedule->id }})" color="green">Edit</x-table.button>
                </x-table.table-data>
    ...
    <div class="mt-3">
        <x-table.button wire:click="$set('addform', true)" color='gray' class="py-3 px-6">Add Schedule</x-table.button>
    </div>
        ...
        <div class="w-full lg:w-8/12 px-4 mx-auto mt-6 absolute top-40 left-96">
            <div
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                    ...
                    <form wire:submit.prevent="scheduleEdited()">
